package com.silverhawk21.technique.NormalBridging.NPC.ConfigBot.BotInteraction.ChangeDistance;
...
import com.silverhawk21.technique.NormalBridging.NPC.ConfigBot.BotInteraction.ChangeDistance.Options.DistancePreset1;
import com.silverhawk21.technique.NormalBridging.NPC.ConfigBot.BotInteraction.ChangeDistance.Options.DistancePreset2;
import com.silverhawk21.technique.NormalBridging.NPC.ConfigBot.BotInteraction.ChangeDistance.Options.DistancePreset3;
...
public class ChangeDistance extends BotInteraction {
      public String GetTitle() {
            return "Islands Distance";
      }

      public void InitOptions() {
            this.getOptions().add(new DistancePreset1());
            this.getOptions().add(new DistancePreset2());
            this.getOptions().add(new DistancePreset3());
